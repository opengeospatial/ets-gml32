...
public class ETSAssert {
    ...
    public static void assertValidPropertyType(XSModel model, XSElementDeclaration propertyDecl,
        ...
        if (isEmpty) {
            ...
            if (isArrayProperty) {
                Assert.assertNull(getAttributeUseByName(attrUses, new QName(Namespaces.XLINK, "href")),
                        ErrorMessage.format(ErrorMessageKeys.ATTRIB_PROHIBITED, "xlink:href",
            ...
            case XSConstants.MODEL_GROUP:
                ...
                if (modelGroup.getCompositor() != XSModelGroup.COMPOSITOR_CHOICE) {
                    throw new AssertionError(
                            "Only a choice compositor is allowed. Found " + particle.getTerm().getClass().getName());
                }
