...
public class DataFixture {
	...
	public void initDataFixture(ITestContext testContext) {
		Assert.assertTrue(testContext.getSuite().getAttributeNames().contains(SuiteAttribute.GML.getName()),
	...
	public String generateXPathExpression(List<QName> elemNames, Map<String, String> namespaceBindings) {
		...
		while (itr.hasNext()) {
			...
			if (null == prefix) {
				prefix = (namespace.equals(GML32.NS_NAME)) ? "gml" : "ns" + itr.previousIndex();
