...
public class GML32 {
	...
	/**
	 * Abstract head of the substitution group for all GML feature instances (see clause
	 * 9.3.2).
	 */
	...
	/**
	 * Abstract head of the substitution group for all GML geometry elements (see clause
	 * 10.1.3.4).
	 */
	...
	/**
	 * Abstract head of the substitution group for all (continuous) curve elements (see
	 * clause 10.4.1).
	 */
	public static final String ABSTRACT_CURVE = "AbstractCurve";

	/**
	 * Abstract head of the substitution group for all (continuous) surface elements (see
	 * clause 10.5.1).
	 */
	public static final String ABSTRACT_SURFACE = "AbstractSurface";

	/**
	 * Generic geometry property type which is typically restricted in an application
	 * schema (see clause 10.1.3.5).
	 */
	...
	/**
	 * Immutable set of all predefined GML geometry property types (see clause 9.5, Table
	 * 4).
	 */
	...
	/**
	 * Abstract head of the substitution group for all GML topology elements (see clause
	 * 13.2).
	 */
	...
	/**
	 * Immutable set of all predefined GML topology property types (see clause 9.6, Table
	 * 5).
	 */
	...
	/**
	 * Abstract head of the substitution group for all temporal primitives and complexes
	 * (see clause 14.2.1.1).
	 */
	...
	/**
	 * Immutable set of all predefined GML temporal property types (see clause 9.7, Table
	 * 6).
	 */
	...
	/**
	 * Abstract head of the substitution group for all coordinate reference system (CRS)
	 * descriptions (see clause 12.2.3.1).
	 */
	public static final String ABSTRACT_CRS = "AbstractCRS";

	/**
	 * Abstract head of the substitution group for all GML coverage elements (see clause
	 * 19.3.1).
	 */
	...
	/**
	 * Head of the substitution group for all definition elements, including dictionaries
	 * (see clause 15.2).
	 */
	public static final String DEFINITION = "Definition";

	/**
	 * Abstract head of the substitution group for all GML value elements (see clauses
	 * 16.4.2, D.3.15).
	 */
	...
	/**
	 * Base type for defining object property types that represent the members of a GML
	 * object collection (see clause 7.2.5.1).
	 */
	public static final String MEMBER_PROP_TYPE = "AbstractMemberType";

	/**
	 * Envelope defines an extent using a pair of positions defining opposite corners in
	 * arbitrary dimensions (see clause 10.1.4.6).
	 */
	...
	/**
	 * Immutable set containing all curve-based geometry elements (that substitute for
	 * gml:AbstractCurve).
	 */
